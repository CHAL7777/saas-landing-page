...
export interface DashboardSettings {
  ...
  // Dashboard overview section visibility
  showSemesterOverview: boolean;
...
export const DEFAULT_SETTINGS: DashboardSettings = {
  ...
  soundEnabled: true,
  // Dashboard overview section visibility - all enabled by default
  showSemesterOverview: true,
