    ...
    <section id="contact" className="py-24 bg-[#020617] border-t border-white/5">
      <div className="container mx-auto px-6 max-w-4xl">
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 px-3 py-1 mb-6 text-xs font-bold tracking-widest uppercase rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-400">
             <MessageSquare size={14} /> Support Available 24/7
          </div>
          <h2 className="text-4xl md:text-5xl font-black text-white mb-4 tracking-tight">
            Talk to our <span className="text-emerald-400">experts</span>
          </h2>
          <p className="text-slate-400">Have specific questions? We're here to help you scale.</p>
        </div>

        <div className="relative group">
          {/* Form Glow Effect */}
          <div className="absolute -inset-1 bg-gradient-to-r from-emerald-500/20 to-teal-500/20 rounded-[2.5rem] blur-xl opacity-50 group-hover:opacity-100 transition duration-1000"></div>
              ...
              {!isSuccess ? (
                ...
                >
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      <label className="block text-xs font-black uppercase tracking-widest mb-2 text-slate-500">Full Name</label>
                      <input
                    ...
                    <div>
                      <label className="block text-xs font-black uppercase tracking-widest mb-2 text-slate-500">Work Email</label>
                      <input
                        {...register("email", { 
                  ...
                  <div>
                    <label className="block text-xs font-black uppercase tracking-widest mb-2 text-slate-500">Company Name</label>
                    <input
                      {...register("company")}
                  ...
                  <div>
                    <label className="block text-xs font-black uppercase tracking-widest mb-2 text-slate-500">Message</label>
                    <textarea
                ...
                >
                  ...
                  <h3 className="text-2xl font-black text-white mb-2 uppercase tracking-tighter">Transmission Received</h3>
                  <p className="text-slate-400 font-medium">Our engineers will reach out within 24 hours.</p>
                  <button 
