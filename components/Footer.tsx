...
const links = {
  platform: ["Academic Dashboard", "Syllabus Scanner", "AI Study Buddy", "Course Analytics"],
  ecosystem: ["Canvas Integration", "Blackboard Sync", "Google Classroom", "Mobile App"],
...
export default function Footer() {
  return (
    <footer className="relative bg-[#020617] border-t border-white/5 pt-24 pb-12 overflow-hidden">
      {/* Subtle Grid Background - Focus Mode Aesthetic */}
      <div className="absolute inset-0 z-0 opacity-20 pointer-events-none">
        <div className="absolute bottom-0 left-0 w-full h-full bg-[linear-gradient(to_right,#1e293b_1px,transparent_1px),linear-gradient(to_bottom,#1e293b_1px,transparent_1px)] bg-[size:3rem_3rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_100%,#000_70%,transparent_100%)]" />
      </div>
          ...
          <div className="col-span-2 lg:col-span-3">
            <div className="flex items-center gap-3 mb-8 group cursor-pointer w-fit">
              ...
              <span className="text-2xl font-black tracking-tighter text-white uppercase italic">
                Scholar<span className="text-emerald-400 not-italic">ly.</span>
              </span>
            </div>
            ...
            <div className="max-w-md relative group">
              <label className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-500 mb-2 block">Join the Study Pulse</label>
